...
export default {
    setup() {
        ...
        const {isTimerRunning, currentStepBuffer,
               maxStepBuffer} = storeToRefs(dashboard)
        const {parseStep, startTimer, pauseTimer, stopTimer,
               setCurrentStepBuffer} = dashboard
        return {isTimerRunning, currentStepBuffer, maxStepBuffer, parseStep,
                startTimer, pauseTimer, stopTimer, setCurrentStepBuffer}
    },
    data() {
        return {
