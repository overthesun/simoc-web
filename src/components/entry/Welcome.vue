            ...
            <BaseEntry v-if="!kioskMode">
                <template #entry-main>
                    <div class="welcome-wrapper">
                        <v-card-title>WELCOME TO SIMOC</v-card-title>

                        <v-card-text>SIMOC is a Scalable, Interactive Model of an Off-world Community.</v-card-text>

                        <v-card-text>Through the SIMOC web interface you will configure and then test a Mars
                            ...
                            right combination to sustain your mission on Mars.</v-card-text>

                        <v-card-text>In using SIMOC, no personal information will be stored or used by SIMOC
                            ...
                            to download your preferred configurations and simulation data.</v-card-text>

                        <v-card-text>If you experience a bug while using SIMOC, please submit a report to
                            ...
                            doing prior to the issue.</v-card-text>

                        <v-card-text>To learn more about SIMOC, enjoy tutorials, and download classroom
                            curricula visit: <a class="link" target="_blank" href="https://simoc.space/">
                                simoc.space</a></v-card-text>

                        <v-card-text>Finally, by pressing the PROCEED button below, you confirm that you have
                            read and agree to the
                            <a class="link" href="https://simoc.space/about/end-user-license-agreement/" target="_blank">End
                                User License Agreement</a>.</v-card-text>
                    </div>
                </template>
