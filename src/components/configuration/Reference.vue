    ...
    <div class="encyclopedia-wrapper">
        <div v-if="getActiveRefEntry === 'Welcome'" class="reference-item">
            <div class="reference-item-title">
                <fa-icon :icon="['fas','list-ul']" @click="SETACTIVEREFENTRY('Table')"
                         title="Go to Table of Contents" /> Welcome To SIMOC
            </div>
            <div class="reference-item-entry">
                <p>Welcome to SIMOC, a scalable, interactive model of an off-world community. Here you will enjoy the challenges and rewards of designing a habitat for <a @click="SETACTIVEREFENTRY('Inhabitants')" class="reference-link" href="#">humans</a> and <a @click="SETACTIVEREFENTRY('PlantSpecies')" class="reference-link" href="#">plants</a> using data from four decades of NASA research that defines the simulated interactions.</p>
                <p>Great effort has been made to develop a realistic model. Your goal is to learn which combination of mechanical life support systems (<a @click="SETACTIVEREFENTRY('ECLSS')" class="reference-link" href="#">ECLSS</a>) and biological components (<a @click="SETACTIVEREFENTRY('Greenhouse')" class="reference-link" href="#">greenhouse</a>) will provide clean air, water, and food for a long-term mission.</p>
        ...
        <div v-if="getActiveRefEntry === 'Location'" class="reference-item">
            <div class="reference-item-title">
                <fa-icon :icon="['fas','list-ul']" @click="SETACTIVEREFENTRY('Table')"
                         title="Go to Table of Contents" /> Location
            </div>
            <div class="reference-item-entry">
                <p>This version of SIMOC offers one location: Mars.  It is assumed the <a @click="SETACTIVEREFENTRY('CrewQuarters')" class="reference-link" href="#">habitat</a> has been built to your specifications and deployed in advance of your arrival.  The habitat is located close to the equator for relatively equal periods of day and night through the Martian year.</p>
        ...
        <div v-if="getActiveRefEntry === 'Inhabitants'" class="reference-item">
            <div class="reference-item-title">
                <fa-icon :icon="['fas','list-ul']" @click="SETACTIVEREFENTRY('Table')"
                         title="Go to Table of Contents" /> Inhabitants
            </div>
            <div class="reference-item-entry">
                <p>While you can use SIMOC to simulate a plant-only configuration, if you design a mission that includes humans, then Environmental Control and Life Support System (<a @click="SETACTIVEREFENTRY('ECLSS')" class="reference-link" href="#">ECLSS</a>), <a @click="SETACTIVEREFENTRY('Food')" class="reference-link" href="#">food</a>, and a <a @click="SETACTIVEREFENTRY('CrewQuarters')" class="reference-link" href="#">crew quarters</a> are required. It is assumed the food and life support required to bring the humans from Earth to Mars are already accounted for, your SIMOC mission starting the day you land and occupy the habitat. Be certain to provide ample food for the astronauts to consume until the <a @click="SETACTIVEREFENTRY('Greenhouse')" class="reference-link" href="#">greenhouse</a> produces the first edible <a @click="SETACTIVEREFENTRY('PlantSpecies')" class="reference-link" href="#">plants</a>. You must include at least one ECLSS to maintain breathable air and potable water, as well as manage human waste products. The ELCSS will likely continue to be used when the plants are harvested or plant growth is not maintained due to environmental constraints.</p>
        ...
        <div v-if="getActiveRefEntry === 'CrewQuarters'" class="reference-item">
            <div class="reference-item-title">
                <fa-icon :icon="['fas','list-ul']" @click="SETACTIVEREFENTRY('Table')"
                         title="Go to Table of Contents" /> Crew Quarters
            </div>
            <div class="reference-item-entry">
        ...
        <div v-if="getActiveRefEntry === 'ECLSS'" class="reference-item">
            <div class="reference-item-title">
                <fa-icon :icon="['fas','list-ul']" @click="SETACTIVEREFENTRY('Table')"
                         title="Go to Table of Contents" /> ECLSS
            </div>
            <div class="reference-item-entry">
                <p>An Environmental Control and Life Support System (ECLSS) is a tightly integrated, mechanical and chemical system whose function is to maintain clean air, water, and relative humidity while sustaining a comfortable temperature for <a @click="SETACTIVEREFENTRY('Inhabitants')" class="reference-link" href="#">human</a> occupants of a closed environment, as used on submarines, the International Space Station, and near future off-world habitats.</p>
                ...
                <p>For long-term missions, it will not be enough to reply on mechanical life support. Rather, a greenhouse can provide plants for CO2 sequestration, oxygen generation, waste processing, and food production. Consider a hybrid solution.</p>
        ...
        <div v-if="getActiveRefEntry === 'Greenhouse'" class="reference-item">
            <div class="reference-item-title">
                <fa-icon :icon="['fas','list-ul']" @click="SETACTIVEREFENTRY('Table')"
                         title="Go to Table of Contents" /> Greenhouse
            </div>
            <div class="reference-item-entry">
                <p>As with the <a @click="SETACTIVEREFENTRY('CrewQuarters')" class="reference-link" href="#">crew quarters</a>, the size of the greenhouse is your choice. If you intend for your astronauts to consume only the <a @click="SETACTIVEREFENTRY('Food')" class="reference-link" href="#">food</a> they have brought with them and rely fully on <a @click="SETACTIVEREFENTRY('ECLSS')" class="reference-link" href="#">mechanical life support</a>, a greenhouse is not required. If you desire for your astronauts to consume some fresh fruits, vegetables, and grains, and for the <a @click="SETACTIVEREFENTRY('PlantSpecies')" class="reference-link" href="#">plants</a> to offset atmosphere and water recycling, a greenhouse is an integral component to a long-duration mission.</p>
        ...
        <div v-if="getActiveRefEntry === 'PlantSpecies'" class="reference-item">
            <div class="reference-item-title">
                <fa-icon :icon="['fas','list-ul']" @click="SETACTIVEREFENTRY('Table')"
                         title="Go to Table of Contents" /> Plant Species
            </div>
            <div class="reference-item-entry">
                <p>If your elect to provide your astronauts with something more interesting than <a @click="SETACTIVEREFENTRY('Food')" class="reference-link" href="#">food rations</a> for a long <a @click="SETACTIVEREFENTRY('Duration')" class="reference-link" href="#">duration</a> mission, a <a @click="SETACTIVEREFENTRY('Greenhouse')" class="reference-link" href="#">greenhouse</a> and plants are a welcomed respite from the monotony of meals in squeeze bottles and aluminum foil containers. Not only do fruits and vegetables provide nutrients and calories, they also help maintain a breathable atmosphere and clean water, off-setting, maybe even replacing the function of the <a @click="SETACTIVEREFENTRY('ECLSS')" class="reference-link" href="#">ECLSS</a> modules. When selecting your plants you will also select the percentage of the total volume of the <a @click="SETACTIVEREFENTRY('Greenhouse')" class="reference-link" href="#">greenhouse</a> allocated to each plant species.</p>
                ...
                <p>Note that each plant is associated with a particular power requirement, that is, the amount of synthetic light required to grow the plants. This is based on NASA data for each included plant species. As such, when you select a higher volume of plants that require more lighting, the <a @click="SETACTIVEREFENTRY('PowerGeneration')" class="reference-link" href="#">power generation</a> and <a @click="SETACTIVEREFENTRY('PowerStorage')" class="reference-link" href="#">storage</a> requirement will increase accordingly.</p>
        ...
        <div v-if="getActiveRefEntry === 'PowerGeneration'" class="reference-item">
            <div class="reference-item-title">
                <fa-icon :icon="['fas','list-ul']" @click="SETACTIVEREFENTRY('Table')"
                         title="Go to Table of Contents" /> Power Generation
            </div>
            <div class="reference-item-entry">
                <p>Select the number of solar photovoltaic (PV) panels required to sustain the electrical power needs of your <a @click="SETACTIVEREFENTRY('CrewQuarters')" class="reference-link" href="#">habitat</a>. This includes electric heat, lighting for the human occupied space, and grow lights for the <a @click="SETACTIVEREFENTRY('PlantSpecies')" class="reference-link" href="#">plants</a> in the <a @click="SETACTIVEREFENTRY('Greenhouse')" class="reference-link" href="#">greenhouse</a>, <a @click="SETACTIVEREFENTRY('ECLSS')" class="reference-link" href="#">ECLSS</a> operation, radio communication from the habitat to the orbiter, and personal computers.</p>
        ...
        <div v-if="getActiveRefEntry === 'PowerStorage'" class="reference-item">
            <div class="reference-item-title">
                <fa-icon :icon="['fas','list-ul']" @click="SETACTIVEREFENTRY('Table')"
                         title="Go to Table of Contents" /> Power Storage
            </div>
            <div class="reference-item-entry">
                <p>While <a @click="SETACTIVEREFENTRY('PowerGeneration')" class="reference-link" href="#">solar PV panels</a> generate power by day, it is the batteries that provide power at night. Therefore, the total battery capacity should be large enough to power the <a @click="SETACTIVEREFENTRY('Greenhouse')" class="reference-link" href="#">greenhouse</a> grow lights, which extends beyond day light hours, with ample power for the <a @click="SETACTIVEREFENTRY('CrewQuarters')" class="reference-link" href="#">habitat</a> through an entire Martian night.</p>
                <p>In review of the <a @click="SETACTIVEREFERENCE('Graphs')" class="reference-link" href="#">energy graph</a> in the Configuration Wizard, the <em>red</em> consumption bar represents the total power required by the habitat for a full Martian day/night cycle. Therefore, by correlating the <em>blue</em> production to <em>red</em> consumption, you will provide ample solar power generation to recharge the battery array to get through the night.</p>
        ...
        <div v-if="getActiveRefEntry === 'Table'" class="reference-item">
            ...
            <ul>
                <li><a @click="SETACTIVEREFENTRY('Welcome')" class="reference-link" href="#">Welcome to SIMOC</a></li>
                <li><a @click="SETACTIVEREFENTRY('Presets')" class="reference-link" href="#">Presets</a></li>
                <li><a @click="SETACTIVEREFENTRY('Location')" class="reference-link" href="#">Location</a></li>
                <li><a @click="SETACTIVEREFENTRY('Duration')" class="reference-link" href="#">Mission Duration</a></li>
                <li><a @click="SETACTIVEREFENTRY('Inhabitants')" class="reference-link" href="#">Inhabitants</a></li>
                <li><a @click="SETACTIVEREFENTRY('Food')" class="reference-link" href="#">Food Supply</a></li>
                <li><a @click="SETACTIVEREFENTRY('CrewQuarters')" class="reference-link" href="#">Crew Quarters</a></li>
                <li><a @click="SETACTIVEREFENTRY('ECLSS')" class="reference-link" href="#">Environmental Control</a></li>
                <li><a @click="SETACTIVEREFENTRY('Greenhouse')" class="reference-link" href="#">Greenhouse</a></li>
                <li><a @click="SETACTIVEREFENTRY('PlantSpecies')" class="reference-link" href="#">Plant Species</a></li>
                <li><a @click="SETACTIVEREFENTRY('PowerGeneration')" class="reference-link" href="#">Power Generation</a></li>
                <li><a @click="SETACTIVEREFENTRY('PowerStorage')" class="reference-link" href="#">Power Storage</a></li>
            </ul>
        </div>
