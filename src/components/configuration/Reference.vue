...
<template>
    <div class="encyclopedia-wrapper">
        <ReferenceItem v-if="activeRefEntry === 'Welcome'" :set-active-ref-entry="setActiveRefEntry"
                       heading="Welcome To SIMOC">
        ...
        <ReferenceItem v-if="(activeRefEntry === 'Presets') && (simLocation === 'mars')"
        ...
        <ReferenceItem v-if="activeRefEntry === 'Inhabitants'" :set-active-ref-entry="setActiveRefEntry"
                       heading="Inhabitants">
        ...
        <ReferenceItem v-if="activeRefEntry === 'Biomes'" :set-active-ref-entry="setActiveRefEntry" heading="Biomes">
        ...
        <ReferenceItem v-if="activeRefEntry === 'CrewQuarters'" :set-active-ref-entry="setActiveRefEntry"
                       heading="Crew Quarters">
        ...
        <ReferenceItem v-if="activeRefEntry === 'ECLSS'" :set-active-ref-entry="setActiveRefEntry"
        ...
        <ReferenceItem v-if="activeRefEntry === 'CO2Management'" :set-active-ref-entry="setActiveRefEntry"
                       heading="CO₂ Management">
        ...
        <ReferenceItem v-if="activeRefEntry === 'O2Management'" :set-active-ref-entry="setActiveRefEntry"
                       heading="O₂ Management">
        ...
        <ReferenceItem v-if="activeRefEntry === 'Greenhouse'" :set-active-ref-entry="setActiveRefEntry"
                       heading="Greenhouse">
        ...
        <ReferenceItem v-if="activeRefEntry === 'PlantSpecies'" :set-active-ref-entry="setActiveRefEntry"
                       heading="Plant Species">
        ...
        <ReferenceItem v-if="activeRefEntry === 'PowerGeneration'" :set-active-ref-entry="setActiveRefEntry"
        ...
        <ReferenceItem v-if="activeRefEntry === 'PowerStorage'" :set-active-ref-entry="setActiveRefEntry"
                       heading="Power Storage">
