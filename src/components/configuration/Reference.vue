...
<template>
    <div class="encyclopedia-wrapper">
        ...
        <ReferenceItem v-if="(activeRefEntry === 'Presets') && (simLocation === 'mars')" heading="Presets">
            ...
            <p>Learn more about the Presets at the <a class="reference-link" :href="kioskMode?null:'https://simoc.space'">SIMOC website</a>.</p>
        ...
        <ReferenceItem v-if="(activeRefEntry === 'Inhabitants') && (simLocation === 'b2')" heading="Inhabitants">
            ...
            <ul class="inhabitants">
                ...
                <li><b>Taber McCallum</b>: In charge of water, air, soil, and tissue analysis lab. Worked on research vessel. <a class="external-link" :href="kioskMode?null:'https://en.wikipedia.org/wiki/Taber_MacCallum'" target="_blank">Wikipedia</a></li>
                <li><b>Mark Nelson</b>: In charge of animal systems and data relay. Background in philosophy and agronomy. <a class="external-link" :href="kioskMode?null:'https://en.wikipedia.org/wiki/Mark_Nelson_(scientist)'" target="_blank">Wikipedia</a></li>
                <li><b>Jane Poynter</b>: In charge of agriculture systems. Background in ecological management. <a class="external-link" :href="kioskMode?null:'https://en.wikipedia.org/wiki/Jane_Poynter'" target="_blank">Wikipedia</a></li>
                <li><b>Dr. Roy Walford</b>: In charge of biospherians' health. Gerontologist with a background in caloric restriction research. <a class="external-link" :href="kioskMode?null:'https://en.wikipedia.org/wiki/Roy_Walford'" target="_blank">Wikipedia</a></li>
            </ul>
            <h3>Mission 2</h3>
            <ul class="inhabitants">
        ...
        <ReferenceItem v-if="activeRefEntry === 'ECLSS'" heading="Environmental Control">
            ...
            <p v-if="simLocation === 'mars'">One ECLSS is able to support 3 human inhabitants. Select how many ECLSS modules you will bring on your mission. Learn more about each of these agents at the <a class="reference-link" target="_blank" :href="kioskMode?null:'https://simoc.space'">SIMOC website</a>.</p>
        ...
        <ReferenceItem v-if="(activeRefEntry === 'PlantSpecies') && (simLocation === 'mars')" heading="Plant Species">
            ...
            <p>Refer to the <a class="reference-link" target="_blank">SIMOC website</a> to learn more about the plant species made available to you.</p>
        ...
        <ReferenceItem v-if="(activeRefEntry === 'PlantSpecies') && (simLocation === 'b2')" heading="Plant Species">
            ...
            <p>Refer to the <a class="reference-link" target="_blank" :href="kioskMode?null:'https://simoc.space'">SIMOC website</a> to learn more about the plant species made available to you.</p>
        </ReferenceItem>
