    ...
    <div class='encyclopedia-wrapper'>
        ...
        <div class='reference-item' v-if="getActiveRefEntry === 'PlantSpecies'">
            ...
            <div class='reference-item-entry'>
                ...
                <p>Refer to <a class='reference-link' target='_blank' href="https://simoc.space">simoc.space</a> to learn more about the plant species made available to you.</p>
