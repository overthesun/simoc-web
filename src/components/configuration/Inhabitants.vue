<template>
    <form class='form-wrapper' ref='inhabitants-form' @submit.prevent="">
        <label class='input-wrapper'>
            ...
            <input class='input-field-number' type="number" pattern="^\d+$" placeholder="Quantity"
        ...
        <label class='input-wrapper'>
            ...
            <select class='input-field-select' ref='crew_quarters_type' v-on:change="setInhabitants" v-model="crewQuarters.type">
    ...
    watch:{
        getConfiguration:{
            handler:function(){
                ...
                this.$refs['inhabitants-form'].reportValidity()
                this.humans = humans
                this.food = food
                this.crewQuarters = crewQuarters
                this.eclss = eclss
            },
            // TODO: check if there's a way to watch only the humans/food/crewQuarters/eclss
